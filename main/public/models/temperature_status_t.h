...
namespace models 
{
    struct Temperature_status_t 
    {
        ...
        friend void to_json(nlohmann::json& json, const Temperature_status_t& value) 
        {
        ...
        friend void from_json(const nlohmann::json& json, Temperature_status_t& value)
        {
